...
export namespace pm8s {
    export namespace v1 {
        export interface GameserverBase {
             ...
             */
            kind?: pulumi.Input<"GameserverBase">;
            /**
             * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
             */
            metadata?: pulumi.Input<inputs.meta.v1.ObjectMeta>;
            spec?: pulumi.Input<inputs.pm8s.v1.GameserverBaseSpec>;
            status?: pulumi.Input<inputs.pm8s.v1.GameserverBaseStatus>;
        }
        ...
        export interface GameserverBaseSpec {
             ...
             */
            updateMechanism?: pulumi.Input<string>;
        }
        ...
        export interface GameserverBaseStatus {
             ...
             */
            conditions?: pulumi.Input<pulumi.Input<inputs.pm8s.v1.GameserverBaseStatusConditions>[]>;
        }
        ...
        export interface GameserverBaseStatusConditions {
            baseInfo?: pulumi.Input<inputs.pm8s.v1.GameserverBaseStatusConditionsBaseInfo>;
            /**
        ...
        export interface GameserverBaseStatusConditionsBaseInfo {
            currentBuildId?: pulumi.Input<number>;
            extendedStatus?: pulumi.Input<string>;
            lastUpdated?: pulumi.Input<number>;
            persistentVolumeClaimName?: pulumi.Input<string>;
            targetBuildID?: pulumi.Input<number>;
        }
        ...
        export interface GameserverOverlay {
             ...
             */
            metadata?: pulumi.Input<inputs.meta.v1.ObjectMeta>;
            spec?: pulumi.Input<inputs.pm8s.v1.GameserverOverlaySpec>;
            status?: pulumi.Input<inputs.pm8s.v1.GameserverOverlayStatus>;
        }
        ...
        export interface GameserverOverlayStatus {
             ...
             * Conditions describing the current state
             */
            conditions?: pulumi.Input<pulumi.Input<inputs.pm8s.v1.GameserverOverlayStatusConditions>[]>;
        }
        ...
        export interface GameserverOverlayStatusConditions {
            baseInfo?: pulumi.Input<inputs.pm8s.v1.GameserverOverlayStatusConditionsBaseInfo>;
            /**
             * lastTransitionTime is the last time the condition transitioned from one status to another. This is not guaranteed to be set in happensBefore order across different conditions for a given object. It may be unset in some circumstances.
             */
            lastTransitionTime?: pulumi.Input<string>;
